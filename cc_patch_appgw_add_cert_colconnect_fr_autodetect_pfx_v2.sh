...
# ============================
# Patch: Import PFX (colconnect.fr + www) autodetect -> KeyVault -> AppGW ssl-cert
# ID: CC_PATCH_APPGW_ADD_CERT_COLCONNECT_FR_AUTODETECT_PFX_V2_20260301
# ============================
...
echo "== [1] Autodetect PFX file (most recent) =="
PFX_PATH="$(find . .. ./certs ./secrets -maxdepth 3 -type f -iname '*.pfx' 2>/dev/null | while read -r f; do
