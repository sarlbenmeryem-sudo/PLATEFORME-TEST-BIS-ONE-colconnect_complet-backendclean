...
# ============================
# Patch: Install scheduled-query extension + create WAF alerts
# ID: CC_PATCH_MONITOR_ALERTS_WAF_V2_INSTALL_EXT_20260301
# ============================
...
echo "== [CC_PATCH_MONITOR_ALERTS_WAF_V2_INSTALL_EXT] Start =="

az account show -o none

echo "== Configure auto-install extensions (no prompt) =="
